...
public class virtualkey {
	...
	public static void main(String[] args) {
		...
		System.out.println("---------------------------------------");
		System.out.println("Name        : Sathwik");
		System.out.println("Email       : Sathwik@company.com");
		...
		lp : while(true)
		{
			...
			case 1: File file = new File("C:\\Users\\sathw\\OneDrive\\Desktop\\virtual key");
					...
					ip : while(true)
					{
						...
						case 1 : System.out.println("\n---------------------------------------");
								 ...
								 try
								 {
									 ...
									 File fe = new File("C:\\Users\\sathw\\OneDrive\\Desktop\\virtual key"+name);
									 if(fe.exists())
									 {
									 ...
									 {
										 FileWriter fw = new FileWriter("C:C:\\Users\\sathw\\OneDrive\\Desktop\\virtual key"+name);
						...
						case 2 : System.out.println("\n---------------------------------------");
								 ...
								 File fd = new File("C:\\Users\\sathw\\OneDrive\\Desktop\\virtual key"+deletename);
								 if(fd.exists())
								 {
									 if(fd.delete())
								        {
						...
						case 3 : System.out.println("\n---------------------------------------");
								 ...
								 try
								 {
									 File filesearch = new File("C:\\Users\\sathw\\OneDrive\\Desktop\\virtual key");
